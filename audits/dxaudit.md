...
description: >
  ...
  Contribution guide, plus verdict, fix plan, Builder handoff, and integration smoke gate.
  Score /320. Preamble v1.0 compliant. Primary audit for CLI/library projects (replaces
  /uiuxaudit + /flowaudit + /motionaudit which ABORT on non-UI). Audit → Plan → Builder handoff (READ-ONLY).
