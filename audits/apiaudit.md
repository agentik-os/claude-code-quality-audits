...
description: >
  ...
  Content negotiation, API deprecation handling, plus verdict, fix plan, Builder handoff,
...
/apiaudit finds validation gaps -> records them in the Builder packet (do not apply)
