...
2. Obey the **AGK-AUDIT-OVERRIDE-V2** block in the first 100 lines of `audits/copyaudit.md` before the rest of that file.
...
5. Emit the 8-file output contract under `audits/.copyaudit/` with `mode=readonly`.
